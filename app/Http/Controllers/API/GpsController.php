             ...
             $geocerca=$vehiclesEstatus[0]->geocerca;
              ...
              $mensajealerta2="";
               ...
               if($alerta==1){ //alerta fija
                ...
                $json1 = file_get_contents("http://api.openweathermap.org/data/2.5/weather?lat=$longitud&lon=$latitud&appid=b6e4d569d1718b07a44702443dd0ed77");
