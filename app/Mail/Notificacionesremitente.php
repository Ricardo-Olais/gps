...
class Notificacionesremitente extends Mailable
{
    ...
    public function build()
    {
        ...
        $fecha="a ".$this->remitente." por medio de fasttransfer ".date("d-m-Y H:i:s");
        return $this->from('noreply@fasttransfer.com.mx', "Fasttransfer")->subject("Has enviado archivos ".$fecha)->view('mails.emailremitente');
