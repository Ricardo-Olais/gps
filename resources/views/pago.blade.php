       ...
       <div class="col s12 m2 l10 animate fadeRight">
         ...
         <div class="card">
            <div class="card-content">
             ...
             <a href="tracker" class="btn waves-effect waves-light" type="submit" name="action" style="width:100%;background-color:#00d3ee;margin-top: 20px;">Comenzar a localizar mi dispositivo
