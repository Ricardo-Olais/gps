...
<head>
    ...
    <link href="https://localizaminave.com/css/vendors.min.css" rel="stylesheet">
    <link href="https://localizaminave.com/css/style2.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link href="https://localizaminave.com/css/materialize.min.css" rel="stylesheet">
    <link href="https://localizaminave.com/css/themes/style.min.css" rel="stylesheet">
    <link href="https://localizaminave.com/css/animate.css" rel="stylesheet">
    <link href="https://localizaminave.com/css/jquery.dataTables.css" rel="stylesheet">
...
<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light navbar-full sidenav-active-rounded">
  <div class="brand-sidebar" style="background-color:black !important;">
    <h1 class="logo-wrapper">
      <a class="brand-logo darken-1" href="index">
        <img src="https://localizaminave.com/images/color.png" alt="materialize logo">
  ...
  <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow ps ps--active-y" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
    ...
    <li class="navigation-header">
     <?php if(isMobile()) { ?>
      <img src="https://localizaminave.com/images/color.png" alt="materialize logo" width="80">
  ...
  <a class="sidenav-trigger btn-sidenav-toggle btn-floating btn-medium waves-effect waves-light hide-on-large-only" href="#" data-target="slide-out">
   ...
   <script src="https://localizaminave.com/js/vendors.min.js" ></script>
   <script src="https://localizaminave.com/js/plugins.min.js" ></script>
   <script src="https://localizaminave.com/js/customizer.min.js" ></script>
   <script src="https://localizaminave.com/js/search.min.js" ></script>
   <script src="https://localizaminave.com/js/jquery.dataTables.js" ></script>
        ...
        <main class="py-4">
            @yield('content')
             <div class="parallax-container">
                <div class="parallax"><img src="https://localizaminave.com/img/home/fondo-carro.jpeg"></div>
              </div>
        </main>
