...
L.control.condensedAttribution({
  ...
  socket.on('ubicacion', function(msg) {
      ...
      $("#comparte").click(function(){
                ...
                window.location.href='https://api.whatsapp.com/send?text=Hola soy '+msg.conductor+', estoy en camino sigue mi viaje, en estos momentos me encuentro en '+msg.direccion+ ', consulta http://localizaminave.com:8080/compartiendo?imei='+imei;
